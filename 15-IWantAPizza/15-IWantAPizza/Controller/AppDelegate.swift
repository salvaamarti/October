...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "_5_IWantAPizza")
    ...
    func application(_ application: UIApplication, continue userActivity: NSUserActivity, restorationHandler: @escaping ([UIUserActivityRestoring]?) -> Void) -> Bool {
        ...
        if(userActivity.activityType == "com.salvadormarti.IWantAPizza.order") {
            ...
            if let order = Order(from: userActivity.userInfo?["order"] as? Data){
                orderVC.finalPizza = order.getPizza()
                orderVC.finalPrice = order.getOrderTotalPrice()
